...
import {
  SiHtml5, SiJavascript, SiReact, SiTailwindcss, SiNodedotjs, SiPython,
  SiPostgresql, SiMongodb, SiDocker, SiKubernetes, SiGithubactions, SiGraphql,
  SiRedis, SiTypescript, SiVite, SiNextdotjs, SiShadcnui, SiBootstrap, SiRedux,
  SiAxios, SiKotlin,
} from "react-icons/si";
...
import { fadeUpSm, staggerContainer } from "@/utils/motion";
...
const ExpertiseCards = () => {
  return (
    <motion.section
      className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-2 sm:p-10 bg-white dark:bg-gray-950"
      initial="hidden"
      whileInView="show"
